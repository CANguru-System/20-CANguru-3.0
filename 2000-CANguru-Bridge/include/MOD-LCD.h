...
// löscht den Bildschirm und zeigt das CANguru an
void backgroundDisplayLCD28();
// gibt die aktuelle Anzahl der Decoder aus
void drawAliveCounts(int power, int sw, int signal, int feedback);
